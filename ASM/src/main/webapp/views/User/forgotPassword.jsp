...
<head>
    ...
    <title>Forgot Password - Netflix Clone</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <section class="text-center my-5">
        <div class="container">
            <h1 class="display-4 custom-title">Forgot Password</h1>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="text-center mt-3">
                                <a href="login.jsp" class="text-muted">Remember your password? Log in</a>
                            </div>
                        </div>
                    </div>
                </div>
